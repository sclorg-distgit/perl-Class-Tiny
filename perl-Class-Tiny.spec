%{?scl:%scl_package perl-Class-Tiny}
...
Name:           %{?scl_prefix}perl-Class-Tiny
Version:        1.006
Release:        12%{?dist}
...
# Devel::GlobalDestruction not needed on Perl >= 5.14
%global __requires_exclude %{?__requires_exclude:%__requires_exclude|}^%{?scl_prefix}perl\\(Devel::GlobalDestruction\\)
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.006-12
- SCL
